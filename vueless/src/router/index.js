...
// 菜单排序控制
const sort = [{name: 'home', icon: 'dashboard'}, {name: 'icons', icon: 'icon'}, {name: 'charts', icon: 'chart'}, {name: 'example', icon: 'example'}, {name: 'zip', icon: 'zip'}, { name: 'i18n', icon: 'international' }];
// 数组对象化
const uu = {};
const u = [];
// 路由装配
